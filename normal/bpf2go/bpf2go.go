...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -go-package bpf2gocgroup -output-dir /usr/share/kmesh -output-stem KmeshCgroupSock -cc clang  --cflags $EXTRA_CFLAGS --cflags $EXTRA_CDEFINE KmeshCgroupSock ../ads/cgroup_sock.c -- -I../ads/include -I../../include -I../../../api/v2-c -DCGROUP_SOCK_MANAGE 
